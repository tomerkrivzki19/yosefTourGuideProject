      ...
      <div className="relative">
              ...
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  <a
                    ...
                    className="text-sm/6 font-semibold text-gray-900"
                  >
                    הצץ בחנות <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="relative z-10 sm:pt-14 lg:w-full lg:max-w-2xl">
            ...
            <div
              className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0 text-center lg:text-right sm:mr-7 "
              dir="rtl"
            >
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                <div className="hidden sm:mb-10 sm:flex justify-center lg:justify-start">
                  <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                    חוויות בלתי נשכחות בטבע ישראל
                    <a
                      href="#"
                      className="whitespace-nowrap font-semibold text-indigo-600"
                    >
                ...
                <h1 className="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                  גלו את ישראל בדרך אחרת
                </h1>
                <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                  הצטרפו אליי למסע מרגש ומלא הרפתקאות ברחבי ישראל! טיולים
                  ייחודיים שיחשפו בפניכם נופים קסומים, היסטוריה מרתקת, תרבות
                  עשירה וחוויות שלא תשכחו.
                </p>
        ...
        <div className="bg-gray-50 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            alt=""
            src="https://images.pexels.com/photos/5249325/pexels-photo-5249325.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
